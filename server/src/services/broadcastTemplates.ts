...
const productUpdate202606: BroadcastTemplate = {
  ...
  description:
    'June 2026 product update: IBKR + Revolut beta imports and the anonymized-sample ask, the new notificare ANAF guide, prior-year (2023/2024) groundwork. No tax rates or deadlines stated.',
  ...
  render(language, unsubscribeUrl) {
    if (language === 'ro') {
      ...
      <p style="margin:0 0 16px;line-height:1.5;"><strong>Pregătim anii fiscali 2023 și 2024.</strong> Regulile pentru anii trecuți sunt deja codificate în aplicație. Lansăm calculul automat în funcție de interesul de pe lista de așteptare din ghid.</p>${unsubFooterHtml('ro', unsubscribeUrl)}`;
...
Pregătim anii fiscali 2023 și 2024. Regulile pentru anii trecuți sunt deja codificate în aplicație. Lansăm calculul automat în funcție de interesul de pe lista de așteptare din ghid.
...
InvesTax · investax.app`;
    ...
    const bodyHtml = `
      ...
      <p style="margin:0 0 16px;line-height:1.5;"><strong>Groundwork for tax years 2023 and 2024.</strong> The rules for past years are already encoded in the app. We will launch automatic computation based on the interest on the waitlist in the guide.</p>${unsubFooterHtml('en', unsubscribeUrl)}`;
...
Groundwork for tax years 2023 and 2024. The rules for past years are already encoded in the app. We will launch automatic computation based on the interest on the waitlist in the guide.
